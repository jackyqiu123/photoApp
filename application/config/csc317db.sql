...
CREATE TABLE `comments` (
  ...
  KEY `key_tousertable_idx` (`fk_postid`),
  KEY `key_tousertable` (`fk_authorid`),
  CONSTRAINT `key_toposttable` FOREIGN KEY (`fk_postid`) REFERENCES `posts` (`id`) ON DELETE CASCADE,
...
-- Dump completed on 2020-12-18 12:52:17
